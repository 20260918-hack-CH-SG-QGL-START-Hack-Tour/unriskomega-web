...
const allowed =
  /^(auth\/(login|logout|me|demo)|admin\/(catalog|runtime|outcomes)|clients|market-context|documents(?:\/[a-f0-9-]+\/(content|import))?|portfolios(?:\/[a-zA-Z0-9_-]+)?|briefings|chat|images|voice\/session|drafts)$/;
