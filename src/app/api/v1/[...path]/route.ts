...
const allowed =
  /^(auth\/(login|logout|me|demo)|admin\/(catalog|runtime|outcomes)|ai\/models|clients|market-context|documents(?:\/[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}(?:\/(content|import))?)?|portfolios(?:\/[a-zA-Z0-9_-]+)?|briefings|chat|images|voice\/session|drafts)$/;
